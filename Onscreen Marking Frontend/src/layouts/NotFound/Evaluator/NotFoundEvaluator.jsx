...
const NotFoundEvaluator = () => {
  return (
    <section class="flex items-center justify-center dark:bg-navy-900">
      <div class="mx-auto my-28 flex max-w-screen-xl items-center justify-center px-4 py-8 lg:px-6 lg:py-16 3xl:my-40">
...
export default NotFoundEvaluator;
