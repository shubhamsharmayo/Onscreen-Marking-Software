...
const AssignModelComp = ({ setassignModel, currentBookletDetails }) => {
  ...
  //     setAssignType(1); // By Booklets
  //   }

  //   if (currentBookletDetails.schemaType === "question_wise") {
  //     setAssignType(2); // By Questions
  //   }
  ...
  const filteredUsers = users.filter((u) => {
    ...
    return role === "evaluator" || role === "headevaluator";
  });
          ...
          <div className="flex items-center justify-between px-6 py-5">
            <div className="flex w-full flex-wrap items-center justify-between gap-4">
              ...
              <select
                ...
                onChange={(e) => setAssignType(Number(e.target.value))}
                disabled={
                  currentBookletDetails?.schemaType === "booklet_wise" ||
                  currentBookletDetails?.schemaType === "question_wise"
                }
              >
                <option
                  value={1}
